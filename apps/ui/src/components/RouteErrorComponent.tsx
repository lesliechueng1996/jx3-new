        ...
        <div className="relative w-full overflow-hidden rounded-2xl border border-white/[0.07] bg-white/2.5 px-8 pt-10 pb-8 shadow-[0_32px_64px_-24px_rgba(0,0,0,0.75)] backdrop-blur-2xl">
          ...
          <div className="flex flex-col gap-3">
            <Button
              ...
              size="lg"
              disabled={isRetrying}
              className="h-11 w-full rounded-xl border-0 text-[15px] font-medium tracking-wide bg-[oklch(0.58_0.17_28)] text-white shadow-[0_8px_32px_-8px_oklch(0.58_0.17_28/0.7)] hover:bg-[oklch(0.54_0.17_28)] active:scale-[0.99] disabled:opacity-70"
              onClick={() => {
                void handleRetry();
              }}
            >
